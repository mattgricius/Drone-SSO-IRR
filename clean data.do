...
append using "$d\dsso_arenas_1_1_back.dta"
append using "$d\dsso_arenas_1_4_back.dta"
append using "$d\dsso_arenas_2_1_back.dta"
append using "$d\dsso_arenas_3_1_back.dta"
append using "$d\dsso_arenas_3_3_back.dta"
append using "$d\dsso_arenas_3_4_back.dta"
append using "$d\dsso_arenas_4_1_back.dta"
append using "$d\dsso_arenas_4_3_back.dta"
append using "$d\dsso_arenas_4_4_back.dta"
...
replace dimebagscount = "-8" if dimebagscount == "NCS"
